...
| content   | text      | Zawartość wiadomości. Korzysta z kodowania znaków UTF-8.                                                             |                                                                                        |                             |                             |
| time      | timestamp | Data i godzina (z dokładnością do sekund) wysłania wiadomości. Nie uwzględnia stref czasowych.                       | nie-null                                                                               |                             |                             |
  ----

### Contacts
Służy do przechowywania kontaktów - powiązań między dwoma użytkownikami, a także informacji dotyczących stanu kontaktu. Każdy zaakceptowany kontakt jest dwoma rekordami w tej tabeli - pojedynczy rekord jest traktowany jako zaproszenie. Aktualizacja pola isAccepted do wartości true powoduje utworzenie kontaktu.
| Nazwa            | Typ    | Opis                                                                                                    | Właściwości i ograniczenia                                                                                                                                                                                                                                                                   | PK                          | FK                          |
| ---------------- | ------ | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | --------------------------- |
| id               | bigint | Klucz główny tabeli.                                                                                    | autoinkrementowane, unikalne, nie-null                                                                                                                                                                                                                                                       | ![](../../images/check.png) |                             |
...
| passwordHash          | varchar   | Hash hasła użytkownika.                                     | określona długość, nie-null, nie-puste                                              |                             |     |
